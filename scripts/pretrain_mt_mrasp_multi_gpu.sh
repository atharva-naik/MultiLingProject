...
#SBATCH --mem=50G
#SBATCH --output=./logs/mt_mrasp_single_gpu_conala_to_10k_per_task_100k.log
#SBATCH --error=./errors/mt_mrasp_single_gpu_conala_to_10k_per_task_100k.err
...
--warmup_ratio 0.05 \
--output_dir ./models/mt_mrasp_single_gpu_conala_to_10k_per_task_100k/